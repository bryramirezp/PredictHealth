# /microservices\service-institutions\app\models\user.py
...
class User(Base):
    ...
    This model is used by domain services to create users in the centralized
    authentication table when creating domain entities.
    """
