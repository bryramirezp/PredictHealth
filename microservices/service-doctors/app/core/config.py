# /microservices\service-doctors\app\core\config.py
# /microservicios/servicio-doctores/app/core/config.py
# Configuración para el servicio de doctores
...
class Settings(BaseSettings):
    """Configuración del servicio de doctores"""
    
    # Configuración de la aplicación
    app_name: str = "Servicio de Doctores PredictHealth"
