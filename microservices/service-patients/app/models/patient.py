# /microservices\service-patients\app\models\patient.py
# /microservicios/servicio-pacientes/app/models/patient.py
# Modelo para pacientes - solo datos de negocio
